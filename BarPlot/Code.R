...
# Create the ggplot object used for the final visualization.
ggplot(df1,mapping=aes(x=ID,y=Mean,fill=Group))+
  # Add the main geometric layer to the plot.
  geom_col(width = 0.8) +
  guides(fill='none')+
  ...
  scale_y_continuous(expand = c(0,0),
                     limits = c(0,1.12))+
  # Adjust plot theme elements for publication-style output.
